        ...
        <Card className="w-full max-w-sm border-[3px] border-ink">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-end">
              <a href="#" className="text-naranja text-xs font-mono font-bold underline">¿Olvidaste tu contraseña?</a>
            </div>
          ...
          <p className="mt-6 text-center text-sm font-mono text-fg">
            ¿No tienes cuenta? <a href="/registro" className="text-naranja font-bold">Registrate gratis</a>
          </p>
        </Card>
      </main>
    </div>
